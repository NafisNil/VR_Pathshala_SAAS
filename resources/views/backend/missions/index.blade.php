                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title">Missions</h3>
                      @if ($missionCount < 1)
                          <a href="{{route('missions.create')}}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Create Mission</a>
                      @endif
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <tbody>
                        @forelse ($missions as $item)
                          ...
                          <td>
                            <a href="{{ route('missions.edit', $item->id) }}" class="btn btn-sm btn-primary mb-2" title="Edit"><i class="fas fa-edit"></i> </a>
                            <form action="{{ route('missions.destroy', $item->id) }}" method="POST" class="d-inline" id="delete-form-{{ $item->id }}">
                                @csrf
                                @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No missions available</td>
                            </tr>
                        @endforelse
