                        ...
                        @forelse ($user as $item)
                          ...
                          <td>
                           <a href="{{ route('users.show', $item->id) }}" class="btn btn-sm btn-primary" title="View"><i class="fas fa-eye"></i> </a>
                             {{-- <form action="{{ route('users.destroy', $item->id) }}" method="POST" class="d-inline" id="delete-form-{{ $item->id }}">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-sm btn-danger delete-btn" data-id="{{ $item->id }}"><i class="fas fa-trash"></i> Delete</button>
                            </form> --}}
                          </td>
                        </tr>
                        @empty
