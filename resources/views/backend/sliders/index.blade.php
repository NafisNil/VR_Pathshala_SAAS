                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title">Sliders</h3>
                      @if ($sliderCount < 1)
                           <a href="{{route('sliders.create')}}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Create Slider</a>
                      @endif
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <tbody>
                        @forelse ($sliders as $item)
                          ...
                          <td>
                            <a href="{{ route('sliders.edit', $item->id) }}" class="btn btn-sm btn-primary mb-2" title="Edit"><i class="fas fa-edit"></i> </a>
                            <form action="{{ route('sliders.destroy', $item->id) }}" method="POST" class="d-inline" id="delete-form-{{ $item->id }}">
                                @csrf
                                @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">No sliders available</td>
                            </tr>
                        @endforelse
