                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title">Vision</h3>
                      @if ($visionCount < 1)
                          <a href="{{route('visions.create')}}" class="btn btn-primary float-end"><i class="fas fa-plus"></i> Create Vision</a>
                      @endif
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <tbody>
                        @forelse ($visions as $item)
                          ...
                          <td>
                            <a href="{{ route('visions.edit', $item->id) }}" class="btn btn-sm btn-primary mb-2" title="Edit"><i class="fas fa-edit"></i> </a>
                            <form action="{{ route('visions.destroy', $item->id) }}" method="POST" class="d-inline" id="delete-form-{{ $item->id }}">
                                @csrf
                                @method('DELETE')
